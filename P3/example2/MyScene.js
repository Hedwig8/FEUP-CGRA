...
class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.ambientLightIntensity = 0.3; //light intensity slider
    }
    initLights() {
    ...
    initMaterials() {
        ...
        this.material4.setDiffuse(0.5, 0.3, 0.2, 1.0);
        this.material4.setSpecular(0.5, 0.3, 0.2, 0.05);
